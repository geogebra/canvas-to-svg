...
test("gradient", () => {
    ...
    canvas.save();
    var radialGradient_1389130830351 = canvas.createRadialGradient(6e1, 6e1, 0.0, 6e1, 6e1, 5e1);
    ...
    canvas.restore();
    canvas.save();
    var radialGradient_1389130830351 = canvas.createRadialGradient(3.5e1, 1.45e2, 0.0, 3.5e1, 1.45e2, 2.5e1);
    radialGradient_1389130830351.addColorStop(0, "red");
    radialGradient_1389130830351.addColorStop(1, "blue");
    canvas.fillStyle = radialGradient_1389130830351;
    canvas.font = "10px sans-serif";
